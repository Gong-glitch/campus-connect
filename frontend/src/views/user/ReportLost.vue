...
async function submit() {
  ...
  try {
    ...
    // Send directly to live server endpoint
    const response = await api.post("/items", backendPayload);

    // Track the generated database auto-increment identity primary key
    ...
    // Instantly download fresh backend data arrays to memory store
