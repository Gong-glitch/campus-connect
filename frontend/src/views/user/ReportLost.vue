  ...
  <main class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <form v-else class="rounded-md bg-white p-6 shadow-soft" @submit.prevent="submit">
      ...
      <div class="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <label><span class="label">Date Lost</span><input v-model="form.date" class="field mt-1" type="date" /><span v-if="errors.date" class="text-xs text-danger">{{ errors.date }}</span></label>
